...
ch01 = """# 제1장: 기본 작업 및 클론 관리

본 장에서는 7단계 대화형 마법사를 사용하여 첫 번째 앱 클론을 생성하는 방법부터 일상적인 실행, 데이터 디렉토리 접근, 원본 앱 업데이트 시 무손실 동기화 업데이트, 테이블 뷰 일괄 작업 및 안전 삭제에 이르기까지 전반적인 관리 절차를 안내합니다.
...
with open(f"{KO_DIR}/01-basic-operations.md", "w", encoding="utf-8") as f:
    f.write(ch01)
print("✓ Created ko/01-basic-operations.md")
