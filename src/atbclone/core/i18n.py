...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "view_recipes_empty_hint": {
        ...
        "ja": "該当するレシピが見つかりません。「+ 新規レシピ」をクリックして追加してください。",
        "ko": "일치하는 레시피가 없습니다. '+ 새 레시피'를 클릭하여 추가하세요.",
        "de": "Keine passenden Rezepte gefunden. Klicken Sie auf '+ Neues Rezept', um eigene hinzuzufügen.",
        "fr": "Aucune recette correspondante. Cliquez sur '+ Nouvelle Recette' pour en ajouter.",
        "ru": "Подходящих рецептов не найдено. Нажмите '+ Новый рецепт', чтобы добавить свой.",
        "es": "No se encontraron recetas coincidentes. Haga clic en '+ Nueva Receta' para añadir una.",
    },
    ...
    "probe_card_target": {
        ...
        "ja": "🎯 対象アプリの選択",
        "ko": "🎯 대상 앱 선택",
        "de": "🎯 Ziel-App auswählen",
        "fr": "🎯 Sélectionner l'application cible",
        "ru": "🎯 Выберите целевое приложение",
        "es": "🎯 Seleccionar aplicación objetivo",
    },
    "probe_input_placeholder": {
        "en": "Select or enter application path, e.g. /Applications/Google Chrome.app",
        "zh": "选择或输入应用路径，如 /Applications/Google Chrome.app",
        "zh_TW": "選擇或輸入應用程式路徑，如 /Applications/Google Chrome.app",
        "ja": "アプリのパスを選択または入力 (/Applications/Google Chrome.app など)",
        "ko": "앱 경로를 선택하거나 입력하세요 (예: /Applications/Google Chrome.app)",
        "de": "App-Pfad auswählen oder eingeben, z.B. /Applications/Google Chrome.app",
        "fr": "Sélectionnez ou entrez le chemin de l'app, ex. /Applications/Google Chrome.app",
        "ru": "Выберите или введите путь к приложению, например /Applications/Google Chrome.app",
        "es": "Seleccione o introduzca la ruta de la app, ej. /Applications/Google Chrome.app",
    },
    "probe_card_results": {
        "en": "📊 Probe Analysis Results",
        "zh": "📊 探测分析结果",
        "zh_TW": "📊 探測分析結果",
        "ja": "📊 解析結果",
        "ko": "📊 분석 결과",
    ...
    "probe_btn_save_recipe": {
        "en": "💾 Save to Custom Recipes",
        "zh": "💾 保存至自定义规则库",
        "zh_TW": "💾 儲存至自訂規則庫",
        "ja": "💾 カスタムレシピに保存",
        "ko": "💾 사용자 지정 레시피에 저장",
        "de": "💾 In eigenen Rezepten speichern",
        "fr": "💾 Enregistrer dans les recettes personnalisées",
        "ru": "💾 Сохранить в рецепты",
        "es": "💾 Guardar en recetas personalizadas",
    },
    "probe_saved_success": {
        "en": "✅ Successfully saved to recipe library!",
        "zh": "✅ 已成功保存至规则库！",
        "zh_TW": "✅ 已成功儲存至規則庫！",
        "ja": "✅ レシピライブラリに保存しました！",
        "ko": "✅ 레시피 라이브러리에 저장되었습니다!",
        "de": "✅ Erfolgreich in Rezeptbibliothek gespeichert!",
        "fr": "✅ Enregistré avec succès dans la bibliothèque de recettes !",
        "ru": "✅ Успешно сохранено в библиотеку рецептов!",
        "es": "✅ ¡Guardado con éxito en la biblioteca de recetas!",
    },

    # ── GUI: Doctor View (view_doctor_*) ───────────────────────────────── #
    "doctor_btn_recheck": {
        "en": "🔄 Recheck",
        "zh": "🔄 重新检测",
        "zh_TW": "🔄 重新檢測",
    ...
    "doctor_initial_status": {
        "en": "Diagnostic Status: Click '🔄 Recheck' at top right for environment status.",
        "zh": "诊断状态: 点击右上角「🔄 重新检测」获取最新环境状态",
        "zh_TW": "診斷狀態: 點擊右上角「🔄 重新檢測」獲取最新環境狀態",
        "ja": "診断状態: 右上の「🔄 再診断」をクリックして最新の環境状態を取得してください",
        "ko": "진단 상태: 오른쪽 상단의 '🔄 다시 검사'를 클릭하여 최신 환경 상태를 확인하세요",
        "de": "Diagnosestatus: Klicken Sie oben rechts auf '🔄 Erneut prüfen'",
        "fr": "État du diagnostic : Cliquez sur '🔄 Revérifier' pour obtenir l'état actuel.",
        "ru": "Статус: Нажмите '🔄 Повторить' для проверки окружения.",
        "es": "Estado del diagnóstico: Haga clic en '🔄 Volver a comprobar'",
    },
