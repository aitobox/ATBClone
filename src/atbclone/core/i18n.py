...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "win_wizard_icon_original": {
        "en": "Original app icon",
        "zh": "原应用图标",
        "zh_TW": "原應用程式圖示",
        "ja": "元のアプリアイコン",
        "ko": "원본 앱 아이콘",
        "de": "Originales App-Symbol",
        "fr": "Icône de l’application d’origine",
        "ru": "Исходный значок приложения",
        "es": "Icono de la aplicación original",
    },
    "win_wizard_icon_choose": {
        "en": "Change icon…",
        "zh": "更换图标…",
        "zh_TW": "更換圖示…",
        "ja": "アイコンを変更…",
    ...
    "win_wizard_icon_reset": {
        ...
        "ru": "Восстановить исходный",
        "es": "Restaurar original",
    },
    "win_wizard_icon_invalid": {
        "en": "Please select an existing .icns file.",
        "zh": "请选择有效的 .icns 文件。",
        "zh_TW": "請選擇有效的 .icns 檔案。",
        "ja": "既存の .icns ファイルを選択してください。",
        "ko": "존재하는 .icns 파일을 선택하세요。",
        "de": "Bitte wählen Sie eine vorhandene .icns-Datei.",
        "fr": "Veuillez sélectionner un fichier .icns existant.",
        "ru": "Выберите существующий файл .icns.",
        "es": "Seleccione un archivo .icns existente.",
    },
    # --- Wizard Command ---
    "wizard_title": {
        "en": "🧙 ATBClone Wizard\n",
    ...
    # ── CloneCard compact icon-replacement buttons (no emoji) ──────────── #
    "btn_open_dir_short": {
        "en": "Dir",
        "zh": "目录",
        "zh_TW": "目錄",
    ...
    "btn_batch_delete": {
        ...
        "ja": "🗑️ 一括削除 ({count})",
        "ko": "🗑️ 일괄 삭제 ({count})",
        "de": "🗑️ Ausgewählte löschen ({count})",
        "fr": "🗑️ Supprimer ({count})",
        "ru": "🗑️ Удалить ({count})",
        "es": "🗑️ Eliminar ({count})",
    },
    ...
    "btn_deleting_progress": {
        "en": "🗑️ Deleting ({current}/{total})...",
        "zh": "🗑️ 正在删除 ({current}/{total})...",
        "zh_TW": "🗑️ 正在刪除 ({current}/{total})...",
        "ja": "🗑️ 削除中 ({current}/{total})...",
        "ko": "🗑️ 삭제 중 ({current}/{total})...",
        "de": "🗑️ Wird gelöscht ({current}/{total})...",
        "fr": "🗑️ Suppression ({current}/{total})...",
        "ru": "🗑️ Удаление ({current}/{total})...",
        "es": "🗑️ Eliminando ({current}/{total})...",
    },
    "btn_browse": {
        "en": "📂 Browse...",
        "zh": "📂 浏览...",
    ...
    "view_clones_filter_all": {
        ...
        "ko": "전체 전략",
        "de": "Alle Strategien",
        "fr": "Toutes les stratégies",
        "ru": "Все стратегии",
        "es": "Todas las estrategias",
    },
    ...
    "view_clones_empty_hint": {
        "en": "No cloned applications yet.",
        "zh": "暂无分身应用",
        "zh_TW": "暫無分身應用程式",
        "ja": "クローンアプリはありません",
        "ko": "클론된 앱이 없습니다",
        "de": "Keine geklonten Apps vorhanden",
        "fr": "Aucun clone trouvé",
        "ru": "Клоны не найдены",
        "es": "No se encontraron clones",
    },
    "view_clones_empty_cta": {
        "en": "Click '+ New Clone' above to create your first clone.",
        "zh": "点击上方「+ 新建分身」立即创建",
        "zh_TW": "點擊上方「+ 新增分身」立即建立",
        "ja": "上の「+ 新規クローン」をクリックして作成してください",
        "ko": "위의 '+ 새 클론'을 클릭하여 생성하세요",
        "de": "Klicken Sie oben auf '+ Neuer Klon', um einen zu erstellen",
        "fr": "Cliquez sur '+ Nouveau Clone' ci-dessus pour en créer un",
        "ru": "Нажмите '+ Новый клон' вверху, чтобы создать первый",
        "es": "Haga clic en '+ Nuevo Clon' arriba para crear uno",
    },
    ...
    "doctor_btn_install_xcode": {
        "en": "📦 Install Xcode Command Line Tools",
        "zh": "📦 一键安装 Xcode 命令行工具",
        "zh_TW": "📦 一鍵安裝 Xcode 命令列工具",
        "ja": "📦 Xcode コマンドラインツールをインストール",
        "ko": "📦 Xcode 명령줄 도구 설치",
        "de": "📦 Xcode-Befehlszeilentools installieren",
        "fr": "📦 Installer les outils de ligne de commande Xcode",
        "ru": "📦 Установить инструменты командной строки Xcode",
        "es": "📦 Instalar herramientas de línea de comandos de Xcode",
    },
    "doctor_hint_xcode_select": {
        "en": "Click 'Install Xcode Command Line Tools' above or run: xcode-select --install",
        "zh": "请点击上方【一键安装】或在终端执行: xcode-select --install",
        "zh_TW": "請點擊上方「一鍵安裝」或在終端機執行: xcode-select --install",
        "ja": "上の「インストール」をクリックするか、ターミナルで実行: xcode-select --install",
        "ko": "위의 '도구 설치'를 클릭하거나 터미널에서 실행: xcode-select --install",
        "de": "Klicken Sie oben auf 'Installieren' oder führen Sie aus: xcode-select --install",
        "fr": "Cliquez sur 'Installer' ci-dessus ou exécutez : xcode-select --install",
        "ru": "Нажмите «Установить» выше или выполните: xcode-select --install",
        "es": "Haga clic en 'Instalar' arriba o ejecute: xcode-select --install",
    },
    "doctor_dialog_install_title": {
        "en": "Xcode Command Line Tools Installation",
        "zh": "Xcode 命令行工具安装指引",
        "zh_TW": "Xcode 命令列工具安裝指引",
        "ja": "Xcode コマンドラインツール インストール手順",
        "ko": "Xcode 명령줄 도구 설치 가이드",
        "de": "Installation der Xcode-Befehlszeilentools",
        "fr": "Installation des outils de ligne de commande Xcode",
        "ru": "Установка инструментов командной строки Xcode",
        "es": "Instalación de herramientas de línea de comandos de Xcode",
    },
    "doctor_dialog_install_msg": {
        "en": "The macOS native installation dialog has been opened.\n\nPlease follow Apple's system prompt to complete the download and installation (~2GB).\n\nOnce the installation completes, please click the [🔄 Recheck] button.",
        "zh": "已为您唤起 macOS 系统原生安装弹窗。\n\n请在系统弹窗中点击【安装】并等待下载安装完成（约 2GB）。\n\n安装完成后，请点击界面右上角【🔄 重新检测】按钮。",
        "zh_TW": "已為您喚起 macOS 系統原生安裝彈窗。\n\n請在系統彈窗中點擊「安裝」並等待下載安裝完成（約 2GB）。\n\n安裝完成後，請點擊介面右上角「🔄 重新檢測」按鈕。",
        "ja": "macOS のネイティブ インストール ダイアログが開きました。\n\nシステムのプロンプトに従ってダウンロードとインストール（約2GB）を完了してください。\n\nインストールが完了したら、右上の [🔄 再検査] ボタンをクリックしてください。",
        "ko": "macOS 기본 설치 대화상자가 열렸습니다.\n\n시스템 안내에 따라 다운로드 및 설치(약 2GB)를 완료하세요.\n\n설치가 완료되면 오른쪽 상단의 [🔄 재검사] 버튼을 클릭하세요.",
        "de": "Der native macOS-Installationsdialog wurde geöffnet.\n\nBitte folgen Sie den Systemanweisungen, um Download und Installation abzuschließen (~2 GB).\n\nKlicken Sie nach Abschluss auf [🔄 Erneut prüfen].",
        "fr": "La boîte de dialogue d'installation macOS native a été ouverte.\n\nVeuillez suivre les instructions du système pour terminer le téléchargement et l'installation (~2 Go).\n\nUne fois l'installation terminée, cliquez sur [🔄 Revérifier].",
        "ru": "Открыто системное окно установки macOS.\n\nСледуйте инструкциям системы для завершения загрузки и установки (~2 ГБ).\n\nПосле завершения установки нажмите кнопку [🔄 Перепроверить].",
        "es": "Se ha abierto el cuadro de diálogo de instalación nativo de macOS.\n\nSiga las instrucciones del sistema para completar la descarga e instalación (~2 GB).\n\nUna vez completada la instalación, haga clic en el botón [🔄 Volver a comprobar].",
    },
    "doctor_dialog_install_already_msg": {
        "en": "Xcode Command Line Tools installation is already in progress or already installed.\n\nPlease complete the system installer or click [🔄 Recheck].",
        "zh": "Xcode 命令行工具已在安装中或已安装。\n\n请完成系统安装流程或点击【🔄 重新检测】。",
        "zh_TW": "Xcode 命令列工具已在安裝中或已安裝。\n\n請完成系統安裝流程或點擊「🔄 重新檢測」。",
        "ja": "Xcode コマンドラインツールは既にインストール中かインストール済みです。\n\nシステムのインストールを完了するか、[🔄 再検査] をクリックしてください。",
        "ko": "Xcode 명령줄 도구가 이미 설치 중이거나 설치되어 있습니다.\n\n시스템 설치를 완료하거나 [🔄 재검사]를 클릭하세요.",
        "de": "Die Xcode-Befehlszeilentools werden bereits installiert oder sind bereits installiert.\n\nBitte schließen Sie die Installation ab oder klicken Sie auf [🔄 Erneut prüfen].",
        "fr": "L'installation des outils de ligne de commande Xcode est déjà en cours ou déjà installée.\n\nVeuillez terminer l'installation ou cliquer sur [🔄 Revérifier].",
        "ru": "Установка инструментов Xcode уже выполняется или они уже установлены.\n\nЗавершите установку или нажмите [🔄 Перепроверить].",
        "es": "La instalación de las herramientas de Xcode ya está en curso o ya está instalada.\n\nComplete el instalador o haga clic en [🔄 Volver a comprobar].",
    },
    "doctor_dialog_install_error_msg": {
        "en": "Failed to launch Xcode installer:\n{error}\n\nPlease try running in Terminal: xcode-select --install",
        "zh": "唤起 Xcode 安装程序失败：\n{error}\n\n请尝试在终端中执行: xcode-select --install",
        "zh_TW": "喚起 Xcode 安裝程式失敗：\n{error}\n\n請嘗試在終端機中執行: xcode-select --install",
        "ja": "Xcode インストーラーの起動に失敗しました:\n{error}\n\nターミナルで実行してください: xcode-select --install",
        "ko": "Xcode 설치 프로그램을 실행하지 못했습니다:\n{error}\n\n터미널에서 실행해 보세요: xcode-select --install",
        "de": "Fehler beim Starten des Xcode-Installationsprogramms:\n{error}\n\nBitte im Terminal ausführen: xcode-select --install",
        "fr": "Échec du lancement du programme d'installation Xcode :\n{error}\n\nVeuillez essayer dans le terminal : xcode-select --install",
        "ru": "Не удалось запустить установщик Xcode:\n{error}\n\nПопробуйте выполнить в терминале: xcode-select --install",
        "es": "Error al iniciar el instalador de Xcode:\n{error}\n\nIntente ejecutar en la Terminal: xcode-select --install",
    },
    "doctor_item_apps_dir": {
        "en": "Application Directory Permissions",
        "zh": "应用程序目录权限",
        "zh_TW": "應用程式目錄權限",
        "ja": "アプリケーションディレクトリ権限",
        "ko": "애플리케이션 디렉터리 권한",
        "de": "Anwendungsverzeichnis-Berechtigungen",
        "fr": "Permissions du répertoire d'applications",
        "ru": "Права на каталог приложений",
        "es": "Permisos del directorio de aplicaciones",
    },
    "doctor_item_data_dir": {
        "en": "Data Storage Directory Permissions",
        "zh": "数据存储目录权限",
        "zh_TW": "資料儲存目錄權限",
        "ja": "データ保存ディレクトリ権限",
        "ko": "데이터 저장 디렉터리 권한",
        "de": "Datenspeicherverzeichnis-Berechtigungen",
        "fr": "Permissions du répertoire de stockage des données",
        "ru": "Права на каталог данных",
        "es": "Permisos del directorio de almacenamiento de datos",
    },
    "doctor_rw_normal": {
        "en": "Read/Write OK",
        "zh": "读写正常",
        ...
        "ja": "読み書き正常",
        "ko": "읽기/쓰기 정상",
        "de": "Lesen/Schreiben OK",
        "fr": "Lecture/Écriture OK",
        "ru": "Чтение/запись в норме",
        "es": "Lectura/Escritura OK",
    },
    "doctor_rw_failed": {
        "en": "Read/Write Failed",
        "zh": "读写异常",
        "zh_TW": "讀寫異常",
        "ja": "読み書き異常",
        "ko": "읽기/쓰기 오류",
        "de": "Lesen/Schreiben fehlgeschlagen",
        "fr": "Échec de lecture/écriture",
        "ru": "Ошибка чтения/записи",
        "es": "Fallo de lectura/escritura",
    },
    "doctor_hint_dir_perm": {
        "en": "Check directory permissions: chmod u+rwx {path}",
        "zh": "检查目录权限: chmod u+rwx {path}",
        "zh_TW": "檢查目錄權限: chmod u+rwx {path}",
        "ja": "ディレクトリ権限を確認: chmod u+rwx {path}",
        "ko": "디렉터리 권한 확인: chmod u+rwx {path}",
        "de": "Berechtigungen prüfen: chmod u+rwx {path}",
        "fr": "Vérifier les permissions : chmod u+rwx {path}",
        "ru": "Проверьте права доступа: chmod u+rwx {path}",
        "es": "Verificar permisos: chmod u+rwx {path}",
    },
    ...
    "win_wizard_step2_select_injection": {
        "en": "Injection Mode:",
        "zh": "注入模式:",
        "zh_TW": "注入模式:",
        "ja": "注入モード:",
    ...
    "detail_label_injection": {
        "en": "Injection Strategy",
        "zh": "注入模式",
        "zh_TW": "注入模式",
        "ja": "注入戦略",
        "ko": "주입 전략",
        "de": "Injektionsstrategie",
        "fr": "Stratégie d'injection",
        "ru": "Стратегия инъекции",
        "es": "Estrategia de inyección",
    },
    "clone_opt_language": {
        "en": "App locale/language (system, zh-Hans, zh-Hant, en, ja, ko)",
        "zh": "应用语言环境（system, zh-Hans, zh-Hant, en, ja, ko）",
        "zh_TW": "應用程式語言環境（system, zh-Hans, zh-Hant, en, ja, ko）",
        "ja": "アプリの言語環境（system, zh-Hans, zh-Hant, en, ja, ko）",
        "ko": "앱 언어 설정（system, zh-Hans, zh-Hant, en, ja, ko）",
        "de": "App-Sprache (system, zh-Hans, zh-Hant, en, ja, ko)",
        "fr": "Langue de l'application (system, zh-Hans, zh-Hant, en, ja, ko)",
        "ru": "Язык приложения (system, zh-Hans, zh-Hant, en, ja, ko)",
        "es": "Idioma de la aplicación (system, zh-Hans, zh-Hant, en, ja, ko)",
    },
    "lang_system": {
        "en": "Follow System (Default)",
        "zh": "跟随系统（默认）",
        "zh_TW": "跟隨系統（預設）",
        "ja": "システム設定に従う（デフォルト）",
        "ko": "시스템 설정 따름 (기본값)",
        "de": "Systemstandard (Standard)",
    ...
    "lang_zh_hans": {
        ...
        "ru": "Упрощенный китайский (zh-Hans)",
        "es": "Chino simplificado (zh-Hans)",
    },
    "lang_zh_hant": {
        ...
        "ja": "繁体字中国語 (zh-Hant)",
        "ko": "중국어 번체 (zh-Hant)",
        "de": "Traditionelles Chinesisch (zh-Hant)",
        "fr": "Chinois traditionnel (zh-Hant)",
        "ru": "Традиционный китайский (zh-Hant)",
        "es": "Chino tradicional (zh-Hant)",
    },
    "lang_en": {
        "en": "English (en)",
        "zh": "英语 (en)",
    ...
    "win_detail_section_injected": {
        "en": "Injected Parameters & Environment",
        "zh": "注入与启动参数",
        "zh_TW": "注入與啟動參數",
        "ja": "注入・起動パラメータ",
        "ko": "주입 및 실행 매개변수",
        "de": "Eingefügte Parameter & Umgebung",
        "fr": "Paramètres et environnement injectés",
        "ru": "Внедренные параметры и окружение",
        "es": "Parámetros y entorno inyectados",
    },
    "win_detail_launch_args": {
        ...
        "ko": "실행 인수",
        "de": "Startargumente",
        "fr": "Arguments de lancement",
        "ru": "Аргументы запуска",
        "es": "Argumentos de inicio",
    },
    "win_detail_env_vars": {
    ...
    "win_detail_exec_cmd": {
        ...
        "ko": "실행 명령",
        "de": "Startbefehl",
        "fr": "Commande de lancement",
        "ru": "Команда запуска",
        "es": "Comando de inicio",
    },
    ...
    "win_detail_btn_copy_all": {
        "en": "Copy All Information",
        "zh": "复制全部信息",
        "zh_TW": "複製全部資訊",
        "ja": "すべての情報をコピー",
        "ko": "모든 정보 복사",
        "de": "Alle Informationen kopieren",
        "fr": "Copier toutes les informations",
        "ru": "Скопировать всю информацию",
        "es": "Copiar toda la información",
    },
    ...
    "proxy_auth_enable": {
        "en": "Proxy Authentication (Username/Password)",
        "zh": "代理身份验证（用户名/密码）",
        "zh_TW": "代理伺服器驗證（使用者名稱/密碼）",
        "ja": "プロキシ認証（ユーザー名/パスワード）",
        "ko": "프록시 인증 (사용자 이름/비밀번호)",
        "de": "Proxy-Authentifizierung (Benutzername/Passwort)",
        "fr": "Authentification proxy (identifiant/mot de passe)",
        "ru": "Аутентификация прокси (логин/пароль)",
        "es": "Autenticación de proxy (usuario/contraseña)",
    },
    "proxy_auth_username": {
        "en": "Username:",
        "zh": "用户名:",
    ...
    "proxy_auth_password_hint": {
        "en": "Stored securely in macOS Keychain",
        "zh": "安全保存在 macOS 系统钥匙串中",
        "zh_TW": "安全保存在 macOS 系統鑰匙圈中",
        "ja": "macOS キーチェーンに安全に保存",
        "ko": "macOS 키체인에 안전하게 저장됨",
        "de": "Sicher im macOS-Schlüsselbund gespeichert",
        "fr": "Stocké en toute sécurité dans le trousseau macOS",
        "ru": "Безопасно хранится в связке ключей macOS",
        "es": "Guardado de forma segura en el llavero de macOS",
    },
    ...
    "win_recipe_btn_advanced_expand": {
        "en": "▶ Advanced Parameters (Expert)",
        "zh": "▶ 高级参数 (专家设置)",
        "zh_TW": "▶ 進階參數 (專家設定)",
        "ja": "▶ 高度な設定 (エキスパート)",
        "ko": "▶ 고급 매개변수 (전문가 설정)",
        "de": "▶ Erweiterte Parameter (Experte)",
        "fr": "▶ Paramètres avancés (Expert)",
        "ru": "▶ Расширенные параметры (Эксперт)",
        "es": "▶ Parámetros avanzados (Experto)",
    },
    "win_recipe_btn_advanced_collapse": {
        "en": "▼ Collapse Advanced Parameters",
        "zh": "▼ 收起高级参数",
        "zh_TW": "▼ 收起進階參數",
        "ja": "▼ 高度な設定を折りたたむ",
        "ko": "▼ 고급 매개변수 접기",
        "de": "▼ Erweiterte Parameter einklappen",
        "fr": "▼ Réduire les paramètres avancés",
        "ru": "▼ Свернуть расширенные параметры",
        "es": "▼ Contraer parámetros avanzados",
    },
    "win_recipe_advanced_warning": {
        "en": "⚠️ For expert customization only. Invalid configurations may prevent the app from launching.",
        "zh": "⚠️ 仅供高级定制，错误配置可能导致应用无法启动",
        "zh_TW": "⚠️ 僅供進階自訂，錯誤設定可能導致應用程式無法啟動",
        "ja": "⚠️ エキスパート専用です。無効な設定を行うとアプリが起動しなくなる可能性があります。",
        "ko": "⚠️ 전문가 전용입니다. 잘못된 설정은 앱 실행을 방해할 수 있습니다.",
        "de": "⚠️ Nur für Experten. Ungültige Konfigurationen können den Start der App verhindern.",
        "fr": "⚠️ Réservé aux experts. Des configurations non valides peuvent empêcher le lancement.",
        "ru": "⚠️ Только для экспертов. Неверные настройки могут помешать запуску приложения.",
        "es": "⚠️ Solo para expertos. Las configuraciones inválidas pueden impedir el inicio de la app.",
    },
    "win_recipe_app_type": {
        "en": "App Type:",
        "zh": "应用类型:",
    ...
    "win_recipe_app_type_auto": {
        ...
        "ja": "自動検出 / 未指定",
        "ko": "자동 감지 / 미지정",
        "de": "Automatisch / Nicht angegeben",
        "fr": "Automatique / Non spécifié",
        "ru": "Автоопределение / Не указано",
        "es": "Automático / No especificado",
    },
    "win_recipe_language": {
        "en": "Display Language:",
        "zh": "界面语言:",
    ...
    "win_recipe_env_hint": {
        "en": "One KEY=VALUE per line. Supports {{ATB_DATA_DIR}} macro.",
        "zh": "每行一条 KEY=VALUE，支持 {{ATB_DATA_DIR}} 宏。",
        "zh_TW": "每行一條 KEY=VALUE，支援 {{ATB_DATA_DIR}} 巨集。",
        "ja": "1行に1つの KEY=VALUE。{{ATB_DATA_DIR}} マクロをサポート。",
        "ko": "한 줄에 하나의 KEY=VALUE. {{ATB_DATA_DIR}} 매크로 지원.",
        "de": "Eine KEY=VALUE pro Zeile. Unterstützt {{ATB_DATA_DIR}} Makro.",
        "fr": "Une KEY=VALUE par ligne. Prend en charge la macro {{ATB_DATA_DIR}}.",
        "ru": "Одна KEY=VALUE на строку. Поддерживает макрос {{ATB_DATA_DIR}}.",
        "es": "Una KEY=VALUE por línea. Soporta macro {{ATB_DATA_DIR}}.",
    },
    ...
    "win_recipe_launch_args_hint": {
        "en": "One argument per line (e.g. --user-data-dir={{ATB_DATA_DIR}}).",
        "zh": "每行一个启动参数（如 --user-data-dir={{ATB_DATA_DIR}}）。",
        "zh_TW": "每行一個啟動參數（如 --user-data-dir={{ATB_DATA_DIR}}）。",
        "ja": "1行に1つの起動引数（例: --user-data-dir={{ATB_DATA_DIR}}）。",
        "ko": "한 줄에 하나의 실행 인수 (예: --user-data-dir={{ATB_DATA_DIR}}).",
        "de": "Ein Argument pro Zeile (z. B. --user-data-dir={{ATB_DATA_DIR}}).",
        "fr": "Un argument par ligne (ex. --user-data-dir={{ATB_DATA_DIR}}).",
        "ru": "Один аргумент на строку (напр. --user-data-dir={{ATB_DATA_DIR}}).",
        "es": "Un argumento por línea (ej. --user-data-dir={{ATB_DATA_DIR}}).",
    },
    "win_recipe_symlink_whitelist": {
        "en": "Symlink Whitelist:",
        "zh": "软链接白名单:",
        "zh_TW": "軟連結白名單:",
        "ja": "シンボリックリンク許可リスト:",
        "ko": "심볼릭 링크 화이트리스트:",
        "de": "Symlink-Whitelist:",
        "fr": "Liste blanche de liens symboliques :",
        "ru": "Белый список симлинков:",
        "es": "Lista blanca de enlaces simbólicos:",
    },
    "win_recipe_symlink_hint": {
        "en": "One path per line.",
        "zh": "每行一个相对或绝对路径。",
        "zh_TW": "每行一個相對或絕對路徑。",
        "ja": "1行に1つのパス。",
        "ko": "한 줄에 하나의 경로.",
        "de": "Ein Pfad pro Zeile.",
        "fr": "Un chemin par ligne.",
        "ru": "Один путь на строку.",
        "es": "Una ruta por línea.",
    },
    "dialog_recipe_invalid_env_line": {
        "en": "Invalid environment variable: line {line_num} '{line}' must follow KEY=VALUE format.",
        "zh": "环境变量解析错误：第 {line_num} 行 '{line}' 格式无效，必须为 KEY=VALUE 格式。",
        "zh_TW": "環境變數解析錯誤：第 {line_num} 行 '{line}' 格式無效，必須為 KEY=VALUE 格式。",
        "ja": "環境変数の解析エラー: 行 {line_num} '{line}' は KEY=VALUE 形式である必要があります。",
        "ko": "환경 변수 구문 분석 오류: {line_num}번째 줄 '{line}'의 형식이 잘못되었습니다. KEY=VALUE 형식이어야 합니다.",
        "de": "Fehler beim Parsen der Umgebungsvariablen: Zeile {line_num} '{line}' muss das Format KEY=VALUE haben.",
        "fr": "Erreur de syntaxe de variable d'environnement : ligne {line_num} '{line}' doit suivre le format KEY=VALUE.",
        "ru": "Ошибка разбора переменных окружения: строка {line_num} '{line}' должна быть в формате KEY=VALUE.",
        "es": "Error de formato de variable de entorno: la línea {line_num} '{line}' debe seguir el formato KEY=VALUE.",
    },
